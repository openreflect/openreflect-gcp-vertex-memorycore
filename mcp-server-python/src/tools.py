...
def register_tools(mcp: FastMCP):
    ...
    async def generate_memories(
        ...
        Example:
            conversation = [
                {"role": "user", "content": "I'm Jordan and I love Python"},
                {"role": "assistant", "content": "Nice to meet you, Jordan!"}
            ]
            await generate_memories(conversation, {"user_id": "demo_user_123"})
        """
        if not app.is_ready():
    ...
    async def retrieve_memories(
        ...
        Examples:
            ...
            await retrieve_memories({"user_id": "demo_user_123"})
    ...
    async def create_memory(
        ...
        Example:
            await create_memory(
                fact="Jordan prefers dark mode in all applications",
                scope={"user_id": "demo_user_123"},
